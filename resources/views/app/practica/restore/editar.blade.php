                  ...
                  <div class="col-md-12">
                      <form role="form" id="form-practica" action="../editar-practica" method="POST" enctype="multipart/form-data">
                          <div class="box box-danger">
                              <input name="id" type="hidden"  value="{{$practica->id}}">
                                  ...
                                  <div class="row">
                                      <div class="col-md-4">
                                          <div class="form-group">
                                              <label>Titulo</label>
                                              <input required type="text" class="form-control" name="titulo" placeholder="Titulo" value="{{$practica->titulo}}">
                                          </div>
                                      </div>
                                      <div class="col-md-12">
                                          <div class="form-group">
                                              <label>Descripción</label>
                                              <input required type="text" class="form-control" name="descripcion" placeholder="Digita la descripciÓn" value='{{$practica->descripcion}}'>
                                          </div>
                                      </div>
                                      <div class="col-md-6">
                                          <div class="form-group">
                                              ...
                                              <select requerid class=" selectpicker form-control" style="width: 100%;" tabindex="-1" aria-hidden="true" name="empresa" id="empresa" data-live-search="true">
                                                  ...
                                                  @foreach ($empresas as $dato)
                                                      <option data-tokens="{{$dato->id}}" value="{{$dato->id}}" @if($dato->id==$practica->empresa) selected @endif >{{$dato->nombre}}</option>
                                                  @endforeach
                                              </select>
                                          </div>
                                      </div>
                                          ...
                                          <div class="form-group">
                                              ...
                                              <select requerid class=" selectpicker form-control" style="width: 100%;" tabindex="-1" aria-hidden="true" name="convenio" id="convenio" data-live-search="true">
                                                @foreach ($convenios as $dato)
                                                    <option data-tokens="{{$dato->id}}" value="{{$dato->id}}" @if($dato->id==$practica->convenio) selected @endif >{{$dato->n_convenio}} - {{$dato->concepto}}</option>
                                                @endforeach
                                              </select>
                                          </div>
                                      </div>
                                          ...
                                          <div class="form-group">
                                              ...
                                              <select requerid class=" selectpicker form-control" style="width: 100%;" tabindex="-1" aria-hidden="true" name="estudiante" data-live-search="true">
                                                  ...
                                                  @foreach ($estudiantes as $dato)
                                                      <option data-tokens="{{$dato->id}}" value="{{$dato->id}}"  @if($dato->id==$practica->estudiante) selected @endif >{{$dato->nombre}} {{$dato->apellido}}</option>
                                                  @endforeach
                                              </select>
                                          </div>
                                      </div>
                                          ...
                                          <div class="form-group">
                                              ...
                                              <select requerid class=" selectpicker form-control" style="width: 100%;" tabindex="-1" aria-hidden="true" name="tutor" data-live-search="true">
                                                  ...
                                                  @foreach ($docentes as $dato)
                                                      <option data-tokens="{{$dato->id}}" value="{{$dato->id}}" @if($dato->id==$practica->tutor) selected @endif >{{$dato->nombre}} {{$dato->apellido}}</option>
                                                  @endforeach
                                              </select>
                                          </div>
                                      </div>
                                          ...
                                          <div class="form-group">
                                              ...
                                              <select requerid class=" selectpicker form-control" style="width: 100%;" tabindex="-1" aria-hidden="true" name="tutor_emp" data-live-search="true">
                                                  ...
                                                  @foreach ($tutores as $dato)
                                                      <option data-tokens="{{$dato->id}}" value="{{$dato->id}}" @if($dato->id==$practica->tutor_emp) selected @endif>{{$dato->nombre}} {{$dato->apellido}}</option>
                                                  @endforeach
                                              </select>
                                          </div>
                                      </div>
                                      <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Año</label>
                                            <input required type="number" class="form-control" name="ano" placeholder="Digita el año" value='{{$practica->ano}}'>
                                        </div>
                                      </div>
                                      <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Semestre</label>
                                            <input required type="number" class="form-control" name="semestre" placeholder="Digita el semestre" value='{{$practica->semestre}}'>
                                        </div>
                                      </div>
                                  </div>
