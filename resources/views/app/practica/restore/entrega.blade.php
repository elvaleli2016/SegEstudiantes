                  ...
                  <div class="col-md-12">
                      <form role="form" id="form-convenio" action="/entrega-practica" method="POST" enctype="multipart/form-data" autocomplete="off">
                          <div class="box box-danger">
                              ...
                              <input name="practica" type="hidden" value="{{ $practica->id }}">
                              <div class="box-body">
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" disabled="" class="form-control" name="practica" value="{{$practica->titulo}}" placeholder="{{$practica->titulo}}">
                                        </div>
                                    </div>
                                      <div class="col-md-6">
                                          <div class="form-group">
