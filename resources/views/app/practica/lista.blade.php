                                ...
                                @foreach ($practicas as $dato)
                                    ...
                                    <tr role="row">
                                     <a href="#">
                                        ...
                                        <a style="color:#FFF" href="/eliminar-practica/{{$dato->id}}" data-original-title="Eliminar" data-toggle="tooltip" class="btn btn-danger btn-sm" ><i class="fa fa-times-circle"></i></a>
                                        @endif
                                    </tr>
