<div class="container content-prin profile">
  <div class="row margin-top-10">
    <div class="headline-center-v2 headline-center-v2-dark margin-bottom-10">
      <h1 class="shop-h1" style="font-size: 30px;"><b>Editar Convenio </b></h1>
        ...
        <div class="container">
          ...
          <div id="registrar_empresa">
              ...
              <section style="padding : 10px 25px 25px 25px;">
                  <div class="col-md-12">
                      <form role="form" id="form-convenio" action="editar-convenio" method="POST" enctype="multipart/form-data" autocomplete="off">
                                  ...
                                  <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input required type="text" class="form-control" name="n_convenio" placeholder="Numero de convenio" value="{{$convenio->n_convenio}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select requerid class=" selectpicker form-control" style="width: 100%;" tabindex="-1" aria-hidden="true" name="empresa" id="empresa" data-live-search="true">
                                                ...
                                                @foreach ($empresas as $dato)
                                                    <option data-tokens="{{$dato->id}}" value="{{$dato->id}}" 
                                                    @if($convenio->empresa==$dato->id) selectec @endif>{{$dato->nombre}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                      ...
                                      <div class="col-md-6">
                                          <div class="form-group">
                                              ...
                                              <input type="text" class="form-control" name="concepto"  placeholder="Digita lel concepto" value="{{$convenio->concepto}}">
                                          </div>
                                      </div>
                                      <div class="col-md-6">
                                          <div class="form-group">
                                              <label for="exampleInputPassword1">Palabra clave</label>
                                              <input type="text" class="form-control" name="palabras_clave"  placeholder="Digita la palabra clave" value="{{$convenio->palabras_clave}}">
                                          </div>
                                      </div>
                                      <div class="col-md-6">
                                          <div class="form-group">
                                              <label >Costo</label>
                                              <input type="text" class="form-control" name="costo"  placeholder="Digita costo" value="{{$convenio->costo}}">
                                          </div>
                                      </div>
                                      <div class="col-md-6">
                                          <div class="form-group">
                                              <label for="exampleInputPassword1">Represntante empresa</label>
                                              <input type="text" class="form-control" name="representante_emp"  placeholder="Digita la representante empresa" value="{{$convenio->representante_emp}}">
                                          </div>
                                      </div>
                                      <div class="col-md-6">
                                          <div class="form-group">
                                              <label for="exampleInputPassword1">Representante universidad</label>
                                              <input type="text" class="form-control" name="representante_uni"  placeholder="Digita la prepresentante universidad"  value="{{$convenio->representante_uni}}">
                                          </div>
                                      </div>
                                      <div class="col-md-6">
                                          <div class="form-group">
