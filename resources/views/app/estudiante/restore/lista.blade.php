                                ...
                                @foreach ($estudiantes as $dato)
                                    ...
                                    <tr role="row" class="usuario-{{$dato->id}}">
                                     <a href="#">
                                        ...
                                        <td>{{$dato['apellido']}}</td>
                                        <td>{{$dato['codigo']}}</td>
                                        <td><a href="/editar-estudiante/{{$dato->id}}" class="btn btn-primary  btn-sm" data-original-title="Editar" data-toggle="tooltip" ><i class="fa fa-edit"></i></a>
                                        <button id="eliminar-estudiante" data-original-title="Eliminar" data-id="{{$dato->id}}" data-toggle="tooltip" class="btn btn-danger btn-sm"> <i class="fa fa-times-circle"></i></button>
                                     </a>
                                    </tr>
