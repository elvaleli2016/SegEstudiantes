...
<div class="container content-prin profile">
  <div class="row margin-top-10">
    <div class="headline-center-v2 headline-center-v2-dark margin-bottom-10">
      <h1 class="shop-h1" style="font-size: 30px;"><b>Registrar Estudiante </b></h1>
        ...
        <div class="container">
          ...
          <div id="registrar_empresa">
              ...
              <section style="padding : 10px 25px 25px 25px;">
                  <div class="col-md-12">
                      <form role="form" id="form-estudiante" action="agregar-estudiante" method="POST" enctype="multipart/form-data">
