...
<div class="container content-prin profile">
  <div class="row margin-top-10">
    <div class="headline-center-v2 headline-center-v2-dark margin-bottom-10">
      <h1 class="shop-h1" style="font-size: 30px;"><b>Estadisticas </b></h1>
      ...
      <div class="row equal-height-columns margin-bottom-10">
        ...
        <div class="col-lg-4 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              ...
              <p style=" color: white; ">Docentes</p>
            </div>
            <div class="icon">
        ...
        <div class="col-lg-4 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              ...
              <p style=" color: white; ">Convenios</p>
            </div>
            <div class="icon">
        ...
        <div class="col-lg-4 col-xs-6">
          ...
          <div class="small-box bg-purple-active">
            <div class="inner">
              <h3 style=" color: white; ">{{$pasantias}}</h3>

              <p style=" color: white; ">Pasantias</p>
            </div>
            <div class="icon">
        ...
        <div class="col-lg-4 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              <h3 style=" color: white; ">{{$practicas}}</h3>

              <p style=" color: white; ">Practicas</p>
            </div>
            <div class="icon">
