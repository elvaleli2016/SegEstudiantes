                                    ...
                                    <tr role="row">
                                     <a href="#">
                                        ...
                                        @if(session('usuario')['tipo']!="docente")
                                          <a style="color:#FFF" title="Eliminar" href="/eliminar-pasantia/{{$dato->id}}" data-original-title="Eliminar" data-toggle="tooltip" class="btn btn-danger btn-sm" ><i class="fa fa-times-circle"></i></a>
                                        @endif
                                    </tr>
