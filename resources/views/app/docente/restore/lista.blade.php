                                    ...
                                    @foreach ($docentes as $dato)
                                        ...
                                        <tr role="row" class="usuario-{{$dato->id}}">
                                         <a href="#">
                                            ...
                                            <button id="eliminar-docente" data-original-title="Eliminar" data-id="{{$dato->id}}" data-toggle="tooltip" class="btn btn-danger btn-sm"> <i class="fa fa-times-circle"></i></button>
                                         </a>
                                        </tr>
