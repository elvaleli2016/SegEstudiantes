                                    ...
                                    <?php $__currentLoopData = $docentes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dato): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <tr role="row" class="usuario-<?php echo e($dato->id); ?>">
                                         <a href="#">
                                            ...
                                            <td><a href="/editar-docente/<?php echo e($dato->id); ?>" class="btn btn-primary  btn-sm" data-original-title="Editar" data-toggle="tooltip" ><i class="fa fa-edit"></i></a>
                                            <button id="eliminar-docente" data-original-title="Eliminar" data-id="<?php echo e($dato->id); ?>" data-toggle="tooltip" class="btn btn-danger btn-sm"> <i class="fa fa-times-circle"></i></button>
                                         </a>
                                        </tr>
