        ...
        <div class="container">
          ...
          <div id="registrar_empresa">
              ...
              <section style="padding : 10px 25px 25px 25px;">
                  <div class="col-md-12">
                      <form role="form" id="form-convenio" action="/entrega-practica" method="POST" enctype="multipart/form-data" autocomplete="off">
                          <div class="box box-danger">
                              <input name="_token" type="hidden" value="<?php echo e(csrf_token()); ?>">
                              <input name="practica" type="hidden" value="<?php echo e($practica->id); ?>">
                              <div class="box-body">
                                  ...
                                  <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input required type="text" disabled="" class="form-control" name="n_convenio" placeholder="<?php echo e($convenio->n_convenio); ?>" value="<?php echo e($convenio->n_convenio); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" disabled="" class="form-control" name="practica" value="<?php echo e($practica->titulo); ?>" placeholder="<?php echo e($practica->titulo); ?>">
                                        </div>
                                    </div>
                                      <div class="col-md-6">
                                          <div class="form-group">
