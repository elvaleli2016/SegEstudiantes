                  ...
                  <div class="col-md-12">
                      <form role="form" id="form-convenio" action="/entrega-pasantia" method="POST" enctype="multipart/form-data" autocomplete="off">
                          <div class="box box-danger">
                              ...
                              <input name="pasantia" type="hidden" value="<?php echo e($pasantia->id); ?>">
                              <div class="box-body">
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" disabled="" class="form-control" name="pasantia-t" value="<?php echo e($pasantia->titulo); ?>" placeholder="<?php echo e($pasantia->titulo); ?>">
                                        </div>
                                    </div>
                                      <div class="col-md-6">
                                          <div class="form-group">
