...
<div class="container content-prin profile">
  <div class="row margin-top-10">
    <div class="headline-center-v2 headline-center-v2-dark margin-bottom-10">
      <h1 class="shop-h1" style="font-size: 30px;"><b>Listado convenios </b></h1>
                        ...
                        <div class="col-sm-12">
                            <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                                ...
                                <?php $__currentLoopData = $convenios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dato): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr role="row">
                                     <a href="#">
                                        <td><?php echo e($dato['n_convenio']); ?></td>
                                        <td><?php echo e($dato['empresa']); ?></td>
                                        <td><?php echo e($dato['concepto']); ?></td>
                                        <td><?php echo e($dato['palabras_clave']); ?></td>
                                        <td><?php echo e($dato['fecha_ini']); ?></td>
                                        <td><?php echo e($dato['fecha_fin']); ?></td>
                                        <td><?php echo e($dato['archivo']); ?></td>
                                        <td><a style="color:#FFF" title="Editar" href="./editar-convenio/<?php echo e($dato->id); ?>" class="btn btn-primary  btn-sm" data-original-title="Editar" data-toggle="tooltip" ><i class="fa fa-edit"></i></a>
                                        <astyle="color:#FFF" title="Eliminar" href="./eliminar-convenio/<?php echo e($dato->id); ?>" data-original-title="Eliminar" data-toggle="tooltip" class="btn btn-danger btn-sm" ><i class="fa fa-times-circle"></i></a>
                                     </a>
                                    </tr>
